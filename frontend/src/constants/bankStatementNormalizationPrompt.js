export const DEFAULT_BANK_STATEMENT_NORMALIZATION_PROMPT = `Normalize the attached bank statement into a standard CSV.
...
export function resolveBankStatementNormalizationPrompt(prompt) {
  const trimmed = prompt?.trim()
  return trimmed || DEFAULT_BANK_STATEMENT_NORMALIZATION_PROMPT
}
